...
For the sniper to work, the Discord account used by the sniper must be inside the Sol's RNG server and must have permission to read the private-server-link channels. You can acess by going in:
